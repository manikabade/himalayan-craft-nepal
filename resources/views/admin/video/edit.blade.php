                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h1 class="card-title">Video Edit Information</h1>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                {!! Form::model($data['row']->id,[
                                    'url'=>route('admin.video.update',$data['row']->id),
                                    'enctype'=>'multipart/form-data',
                                    'id'=>'edit-form']
                                   ) !!}

{{--                                <form action="{{route('video.update',$data['row']->id)}}" method="POST" enctype="multipart/form-data">--}}
