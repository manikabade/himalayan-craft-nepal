        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3>Video</h3><br>
                        <a class="btn btn-outline-primary " href="{{route('admin.video.create')}}" role="button">Create Video</a>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">List of Video</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                {{--                                <div class="row">--}}
                                    ...
                                    @forelse($videos as $video)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <video height="100px" width="100px" src="{{asset('videos/video/'.$video->video)}}">
                                            </td>

                                            <td>
                                                {!! $video->status ?'<span class="badge badge-success">Active</span>':'<span class="badge badge-danger">InActive</span>' !!}
                                            </td>

                                            <td>
                                                <div class="row">
                                                    <a class="btn btn-success" href="{{route('admin.video.edit',$video->id)}}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>

                                                    <a href="javascript:void(0)" onclick="var c = confirm('{{ "Are you sure?" }}'); if(c){document.getElementById('delete-{{$video->id}}').submit();}" class="btn btn-sm swalDefaultQuestion btn-danger">
                                                        <i class="fa fa-trash"></i>
                                                        <form id="delete-{{$video->id}}" action="{{ route('admin.video.destroy',$video->id) }}" method="POST"  style="display: none;">
                                                            @method('DELETE')
                                                            @csrf
                                                        </form>
                                                    </a>
